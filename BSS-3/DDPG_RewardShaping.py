...
np.save("Bike_{}_RewardShaping_Tabular_before_Action".format(arg_seed),store_before_action)
np.save("Bike_{}_RewardShaping_Tabular_After_Action".format(arg_seed),store_after_action)
np.save("Bike_{}_RewardShaping_Tabular_eval_reward".format(arg_seed),eva_reward)
np.save("Bike_{}_RewardShaping_Tabular_eval_before_Action".format(arg_seed),store_testing_before_action)
np.save("Bike_{}_RewardShaping_Tabular_eval_after_Action".format(arg_seed),store_testing_after_action)
