...
np.save("Network_{}_DDPGwithProj_NSFnet_multi_new_Reward".format(arg_seed),ewma)
np.save("Network_{}_DDPGwithProj_NSFnet_multi_new_store_network_output_action".format(arg_seed),store_network_output_action)
np.save("Network_{}_DDPGwithProj_NSFnet_multi_new_before_Action".format(arg_seed),store_before_action)
np.save("Network_{}_DDPGwithProj_NSFnet_multi_new_after_Action".format(arg_seed),store_after_action)
np.save("Network_{}_DDPGwithProj_NSFnet_multi_new_eval_reward".format(arg_seed),eva_reward)
