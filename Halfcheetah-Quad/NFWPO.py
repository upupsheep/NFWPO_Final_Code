...
np.save("Halfcheetah_{}_DDPGFW_before_Action_Cons1".format(
    arg_seed), store_before_action)
np.save("Halfcheetah_{}_DDPGFW_after_Action_Cons1".format(
    arg_seed), store_after_action)
np.save("Halfcheetah_{}_DDPGFW_eval_reward_Cons1".format(arg_seed), eva_reward)
np.save("Halfcheetah_{}_DDPGFW_before_Action_Gaussian_Cons1".format(
    arg_seed), store_before_action_and_gaussain)
np.save("Halfcheetah_{}_DDPGFW_eval_before_Action_Cons1".format(
    arg_seed), store_testing_before_action)
np.save("Halfcheetah_{}_DDPGFW_eval_After_Action_Cons1".format(
