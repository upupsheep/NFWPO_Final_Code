...
np.save("Halfcheetah_{}_RewardShape_before_Action_state_relate".format(
    arg_seed), store_before_action)
np.save("Halfcheetah_{}_RewardShape_after_Action_state_relate".format(
    arg_seed), store_after_action)
np.save("Halfcheetah_{}_RewardShape_eval_reward_state_relate".format(
    arg_seed), eva_reward)
np.save("Halfcheetah_{}_RewardShape_before_Action_Gaussian_state_relate".format(
    arg_seed), store_before_action_and_gaussain)
np.save("Halfcheetah_{}_RewardShape_eval_before_Action_state_relate".format(
    arg_seed), store_testing_before_action)
np.save("Halfcheetah_{}_RewardShape_eval_After_Action_state_relate".format(
