        ...
        for i in range(BATCH_SIZE):
            with gp.Env(empty=True) as env:
                ...
                with gp.Model(env=env) as fw_m:
                    ...
                    fw_m.addConstr((abs_u1 + abs_u2 + abs_u3 + abs_u4 + abs_u5 + abs_u6 )== v)
...
np.save("Halfcheetah_{}_NFWPO_before_Action_State_relate_cons".format(arg_seed),store_before_action)
np.save("Halfcheetah_{}_NFWPO_after_Action_State_relate_cons".format(arg_seed),store_after_action)
np.save("Halfcheetah_{}_NFWPO_eval_reward_State_relate_cons".format(arg_seed),eva_reward)
np.save("Halfcheetah_{}_NFWPO_before_Action_Gaussian_State_relate_cons".format(arg_seed),store_before_action_and_gaussain)
np.save("Halfcheetah_{}_NFWPO_eval_before_Action_State_relate_cons".format(arg_seed),store_testing_before_action)
np.save("Halfcheetah_{}_NFWPO_eval_After_Action_State_relate_cons".format(arg_seed),store_testing_after_action)
