...
from TRPO_Projection_Halfcheetah_State_Relate_gym import ClippedGaussianPolicy
...
to numpy.ndarray of numpy.float32.""")  # NOQA
    ...
    if args.demo:
        ...
        np.save("Halfcheetah_{}_PPO_Evaluation_Reward_State_relate".format(args.seed),eva_reward)
        np.save("Halfcheetah_{}_PPO_Action_before_State_relate".format(args.seed),action_before)
        np.save("Halfcheetah_{}_PPO_Action_After_State_relate".format(args.seed),action_after)
        np.save("Halfcheetah_{}_PPO_Training_Reward_State_relate".format(args.seed),reward)
