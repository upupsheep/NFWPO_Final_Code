...
np.save("Halfcheetah_{}_DDPGProjection_Reward_State_relate_cons".format(
    arg_seed), reward)
np.save("Halfcheetah_{}_DDPGProjection_before_Action_State_relate_cons".format(
    arg_seed), store_before_action)
np.save("Halfcheetah_{}_DDPGProjection_after_Action_State_relate_cons".format(
    arg_seed), store_after_action)
np.save("Halfcheetah_{}_DDPGProjection_eval_reward_State_relate_cons".format(
    arg_seed), eva_reward)
np.save("Halfcheetah_{}_DDPGProjection_before_Action_Gaussian_State_relate_cons".format(
    arg_seed), store_before_action_and_gaussain)
np.save("Halfcheetah_{}_DDPGProjection_eval_before_Action_Gaussian_State_relate_cons".format(
    arg_seed), store_testing_before_action)
np.save("Halfcheetah_{}_DDPGProjection_eval_After_Action_Gaussian_State_relate_cons".format(
