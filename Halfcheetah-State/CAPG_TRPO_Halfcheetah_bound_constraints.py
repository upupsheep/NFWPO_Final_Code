...
to numpy.ndarray of numpy.float32.""")  # NOQA
    ...
    if args.demo:
        ...
        np.save("Halfcheetah_{}_TRPO_withoutCAPG_Evaluation_Reward_Lower_upper".format(args.seed),eva_reward)
        np.save("Halfcheetah_{}_TRPO_withoutCAPG_Action_before_Lower_upper".format(args.seed),action_before)
        np.save("Halfcheetah_{}_TRPO_withoutCAPG_Action_After_Lower_upper".format(args.seed),action_after)
        np.save("Halfcheetah_{}_TRPO_withoutCAPG_Training_Reward_Lower_upper".format(args.seed),reward)
