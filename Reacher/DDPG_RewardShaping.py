...
np.save("Reacher_{}_RewardShaping_before_Action".format(
    arg_seed), store_before_action)
np.save("Reacher_{}_RewardShaping_after_Action".format(
    arg_seed), store_after_action)
np.save("Reacher_{}_RewardShaping_eval_reward".format(arg_seed), eva_reward)
np.save("Reacher_{}_RewardShaping_before_Action_Gaussian".format(
    arg_seed), store_before_action_and_gaussain)
np.save("Reacher_{}_RewardShaping_eval_before_Action".format(
    arg_seed), store_testing_before_action)
np.save("Reacher_{}_RewardShaping_eval_After_Action".format(
