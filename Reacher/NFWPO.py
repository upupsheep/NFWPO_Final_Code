...
np.save("Reacher_{}_DDPGFw_before_Action".format(arg_seed),store_before_action)
...
np.save("Reacher_{}_DDPGFw_before_Action_Gaussian".format(arg_seed),store_before_action_and_gaussain)
np.save("Reacher_{}_DDPGFW_eval_before_Action".format(arg_seed),store_testing_before_action)
np.save("Reacher_{}_DDPGFW_eval_After_Action".format(arg_seed),store_testing_after_action)
