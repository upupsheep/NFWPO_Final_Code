...
to numpy.ndarray of numpy.float32.""")  # NOQA
    ...
    if args.demo:
        ...
        np.save("Reacher_{}_TRPO_Evaluation_Reward_Batch_modify".format(args.seed),eva_reward)
        np.save("Reacher_{}_TRPO_Action_before_Batch_modify".format(args.seed),action_before)
        np.save("Reacher_{}_TRPO_Action_After_Batch_modify".format(args.seed),action_after)
        np.save("Reacher_{}_TRPO_Training_Reward_Batch_modify".format(args.seed),reward)
